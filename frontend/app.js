    ...
    request.done(function(results){
      ...
      if (results) {
        ...
        var questionnaire = [
          ...
          "<h1>Your Activity</h1></br><p>Tell us how you like to spend your time (select all that apply)</p></br><p>I like to...</p></br>",
          ...
          "<div class='pet'><div class='col-xs-8 col-xl-4'><p3>I am looking for a (select all that apply)</p></br><label><input type='checkbox' name='restrictions'>Dog</label></div><div class='col-xs-8 col-xl-4'><label><input type='checkbox' name='restrictions'>Cat</label></div></div>"
        ]
